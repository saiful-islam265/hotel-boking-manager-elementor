 ...
 * @since 1.1.0
 */
class HotelInfoImageRight extends Widget_Base {
	
	public function get_name() {
		return 'hotel-info-image-right';
	}
	
	public function get_title() {
		return __( 'Info Image Right', 'elementor-hello-world' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wtbm_elementor_widget_img_right h2' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'imgr_title_typography',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
				'selector' => '{{WRAPPER}} .wtbm_elementor_widget_img_right h2',
			]
		);
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			[
				'name'     => 'imgr_title_text_shadow',
				'selector' => '{{WRAPPER}} .wtbm_elementor_widget_img_right h2',
			]
		);
		
		$this->add_control(
			'imgr_title_blend_mode',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .wtbm_elementor_widget_img_right h2' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					// '.whbmt_subscribe_hotels button.wpmsems-btn' => 'color: {{VALUE}};',
					'{{WRAPPER}} .wtbm_elementor_widget_img_right p' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name'     => 'imgr_content_typography',
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
				'selector' => '{{WRAPPER}} .wtbm_elementor_widget_img_right p',
			]
		);
		$this->add_group_control(
			Group_Control_Text_Shadow::get_type(),
			[
				'name'     => 'imgr_content_text_shadow',
				'selector' => '{{WRAPPER}} .wtbm_elementor_widget_img_right p',
			]
		);
		
		$this->add_control(
			'imgr_content_blend_mode',
			[
				'label'     => __( 'Blend Mode', 'elementor' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
				...
				'selectors' => [
					'{{WRAPPER}} .wtbm_elementor_widget_img_right p' => 'mix-blend-mode: {{VALUE}}',
				],
				'separator' => 'none',
			]
		);
	...
	protected function render() {
        ...
        <section class="whbmt_customer_support_hotels pad wtbm_elementor_widget_img_right">
            <div class="container">
                <div class="row">
